...
def moving_average(x, y, n) -> Tuple[int, int, int]:
    """
...
# COMPLETAR
# Se puede consultar los argumentos del programa usando args.window_size, etc.
rtts = []
while True:
    packet_send_time, rtt = send_ping()
    rtts.append((packet_send_time, rtt))
    if packet_send_time > start + args.duration:
       break 
